  ...
  return (
    <main className="min-h-screen bg-slate-950 px-4 py-16 text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <h1 className="text-4xl font-black text-white">Privacy placeholder</h1>
        <p className="mt-6 leading-8 text-slate-400">This placeholder page exists so the landing page footer has a real destination. Replace it with your actual privacy policy before launch.</p>
      </div>
    </main>
  );
}
